...
### git status -s  
-> This command tells the small status of working tree.  
### git branch  
-> This command shows total branches and in which branch we are on.  
### git branch filename  
...
-> This command performs the commit without shifting to staging area.  
### git rm filename  
-> This command removes file from hard disk.
### git log 
-> This command shows all the commits done in the branch from starting.  
### git checkout -f 
-> This commands undos all the files to its previous commit state.  
### git branch 
-> This command lists out all the branches in the repository.
### clear  
-> This command clears the Git Bash.
